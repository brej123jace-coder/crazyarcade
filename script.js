(function () {
  ...
  var boards = {
    'overload': {
      title: 'OVERLOAD — TOP SCORES',
      scores: [
        ['1', 'VXN', '312,600', 'Aug 30'],
    ...
    'blaze-fist': {
      title: 'BLAZE FIST — TOP SCORES',
      scores: [
        ['1', 'RGE', '284,900', 'Aug 22'],
        ['2', 'KIP', '271,150', 'Aug 14'],
        ['3', 'ZUL', '260,300', 'Jul 30'],
        ['4', 'MDX', '248,700', 'Aug 3'],
        ['5', 'TAO', '239,050', 'Jul 19'],
        ['6', 'CRW', '221,400', 'Jul 11']
      ]
    },
    'scrap-jockey': {
      title: 'SCRAP JOCKEY — TOP SCORES',
      scores: [
        ['1', 'GRZ', '61,300', 'Aug 28'],
        ['2', 'FLT', '58,900', 'Aug 16'],
        ['3', 'YLW', '55,420', 'Aug 4'],
    ...
    'meltdown-maze': {
      title: 'MELTDOWN MAZE — TOP SCORES',
      scores: [
        ['1', 'QRT', '88,410', 'Aug 31'],
        ['2', 'IVY', '84,900', 'Aug 21'],
        ['3', 'SKN', '81,225', 'Aug 10'],
  ...
  var tournaments = [
    ...
    {
      name: 'Scrap Jockey Rumble',
      date: new Date('2026-10-23T16:00:00'),
